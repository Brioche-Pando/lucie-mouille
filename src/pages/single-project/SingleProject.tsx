...
const SingleProject: React.FC = () => {
  ...
  const project: ProjectData | undefined = Object.values(
    DataProjects[userLanguage]
  ).find((project: { slug: string | undefined }) => project.slug === slug)
  ...
  return (
    <article className='project'>
      ...
      <div className='project__content'>
        <div>
          <h3>{translate('Projects', 'context')}</h3>
          <p>{project.context}</p>
          <h3>{translate('Projects', 'approach')}</h3>
          <ul>
        ...
        <div className='project__content-skills'>
          <h4>
            ...
            {translate('Projects', 'mainChallenges')}
          </h4>
          <ul>
          ...
          <h4>
            ...
            {translate('Projects', 'acquiredSkills')}
          </h4>
          <ul>
          ...
          <h4>
            ...
            {translate('Projects', 'skillsToBeDeveloped')}
          </h4>
          <ul>
