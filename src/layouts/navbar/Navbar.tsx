    ...
    <nav className='navbar'>
      {isSingleProjectPage && (
        ...
        >
          ...
          <span>{translate('Navigation', 'backToProjects')}</span>
        </Link>
      )}
      <ul className='navbar__list'>
        ...
        >
          <Navigation
            ...
            content={translate('Navigation', 'home')}
          />
        </li>
        <li
          className={`navbar__list-item ${
        ...
        >
          <Navigation
            ...
            content={translate('Navigation', 'myProjects')}
          />
        </li>
        <li
          className={`navbar__list-item ${
        ...
        >
          <Navigation
            ...
            content={translate('Navigation', 'aboutMe')}
          />
        </li>
        ...
        <li className='navbar__list-item'>
          <Button
            ...
            target='_blank'
            content={translate('Navigation', 'contact')}
            additionnal_class=''
          />
        </li>
      </ul>
